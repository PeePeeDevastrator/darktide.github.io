<head>
<title>Discord / game4sense</title>
</head>
<?php
...
if ($pun_user['g_read_board'] == '0')
 ...
 require __DIR__ . '/vendor/autoload.php';
  ...
  //$provider = new \Wohali\OAuth2\Client\Provider\Discord([
      'clientId' => '1324414782211756062', //discord id client
      'clientSecret' => 'MsggPa8sMJNTtRFsVwpVYYONNCwxf2kG', //secret discord
      'redirectUri' => 'https://skeetpro.000webhostapp.com/forums/discord.php' // redirect url
  ]);
  $options = [
...
//$discord = new DiscordClient(['token' => mU']); //
...
$client = new DiscordClient([
	 ...
	 // $acceptedRoles = ["Premium User"];
		$client->guild->addGuildMember([
			'guild.id' => 1322977687169536060//discord server id
			'user.id' => (int)$discord_id,
			'access_token' => (string)$token,
			'nick' => $sessionuser,
			'roles' => array(8177860258533212188,817786025853321218) //discord roles
			//'roles' => 817786025853321218, 'name' => 'Premium user', 'color' => 16729413, 'hoist' => true, 'managed' => false, 'mentionable' => true, 'position' => 6, 'permissions' => 37080128)
		]);
